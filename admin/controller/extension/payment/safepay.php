...
class ControllerExtensionPaymentSafepay extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['payment_safepay_sandbox_secretkey'])) {
			$data['error_payment_safepay_sandbox_secretkey'] = $this->error['payment_safepay_sandbox_secretkey'];
		} else {
			$data['error_payment_safepay_sandbox_secretkey'] = '';
		}
		...
		if (isset($this->error['payment_safepay_secretkey'])) {
			$data['error_payment_safepay_secretkey'] = $this->error['payment_safepay_secretkey'];
		} else {
			$data['error_payment_safepay_secretkey'] = '';
		}
		...
		if (isset($this->request->post['payment_safepay_sandbox_secretkey'])) {
			$data['payment_safepay_sandbox_secretkey'] = $this->request->post['payment_safepay_sandbox_secretkey'];
		} else {
			$data['payment_safepay_sandbox_secretkey'] = $this->config->get('payment_safepay_sandbox_secretkey');
		}		
		...
		if (isset($this->request->post['payment_safepay_secretkey'])) {
			$data['payment_safepay_secretkey'] = $this->request->post['payment_safepay_secretkey'];
		} else {
			$data['payment_safepay_secretkey'] = $this->config->get('payment_safepay_secretkey');
		}
	...
	protected function validate() {
		...
		if ($this->request->post['payment_safepay_mode'] == 'sandbox' && !$this->request->post['payment_safepay_sandbox_apikey']) {
			$this->error['payment_safepay_sandbox_apikey'] = $this->language->get('error_required');
			$this->error['warning'] = $this->language->get('error_warning');
		}
		
		if ($this->request->post['payment_safepay_mode'] == 'sandbox' && !$this->request->post['payment_safepay_sandbox_secretkey']) {
			$this->error['payment_safepay_sandbox_secretkey'] = $this->language->get('error_required');
			$this->error['warning'] = $this->language->get('error_warning');
		}		
		
		if ($this->request->post['payment_safepay_mode'] == 'production' && !$this->request->post['payment_safepay_apikey']) {
			$this->error['payment_safepay_apikey'] = $this->language->get('error_required');
			$this->error['warning'] = $this->language->get('error_warning');
		}
		
		if ($this->request->post['payment_safepay_mode'] == 'production' && !$this->request->post['payment_safepay_secretkey']) {
			$this->error['payment_safepay_secretkey'] = $this->language->get('error_required');
			$this->error['warning'] = $this->language->get('error_warning');
		}		
